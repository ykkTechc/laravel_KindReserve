            ...
            <section class="text-gray-600 body-font">
              ...
              @if (session('status'))
               ...
               <div class="flex justify-between">
                 <button onclick="location.href = '{{ route('events.past')}}'" class="flex mb-4 ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-500 rounded">過去のイベント一覧</button>
